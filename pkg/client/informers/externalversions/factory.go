...
type SharedInformerFactory interface {
	...
	Kconfigcontroller() kconfigcontroller.Interface
}

func (f *sharedInformerFactory) Kconfigcontroller() kconfigcontroller.Interface {
	return kconfigcontroller.New(f, f.namespace, f.tweakListOptions)
}
