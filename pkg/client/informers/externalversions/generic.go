...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=kconfigcontroller.atteg.com, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("deploymentbindings"):
	...
	case v1alpha1.SchemeGroupVersion.WithResource("statefulsetbindings"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kconfigcontroller().V1alpha1().StatefulSetBindings().Informer()}, nil
